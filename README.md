...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=24&duration=3000&pause=500&color=00FF41&center=true&vCenter=true&width=600&lines=Cybersecurity+Professional;Python+%7C+R+%7C+Network+Defense;Threat+Hunting+%7C+Data+Analytics;Protecting+Digital+Assets)](https://git.io/typing-svg)
...
|---------|------------|--------|-------------|
| 📱 **Social Media Impact Analysis** | Python, Pandas, SciPy | ✅ Complete | Hypothesis testing on student performance |
| 🚢 **Titanic Survival Prediction** | R, ggplot2, dplyr | ✅ Complete | EDA with 78% model accuracy |
| 📚 **Web Scraping Pipeline** | R, rvest, tidyverse | ✅ Complete | 1,000+ books dataset |
| 🛡️ **IDS/IPS Implementation** | Snort, Suricata | 🔄 In Progress | Custom rule development |
